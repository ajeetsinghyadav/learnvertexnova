...
When you press a key or move the mouse, the window library (e.g. [GLFW](https://github.com/glfw/glfw)) tells your program “this just happened” via [window and input events](https://www.glfw.org/docs/3.3/window_guide.html#window_events). If you handle that in one place with a single, consistent set of event types, you can:
