...
<!-- Add static/img/learn/diagrams/03_event_types.png (export from static/img/learn/diagrams/03_event_types.excalidraw) -->
![vneevents event type taxonomy — Keyboard, Mouse, Window, Touch categories with class names and accessors](/img/learn/diagrams/03_event_types.png)
