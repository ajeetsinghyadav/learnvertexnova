...
const config = {
  ...
  future: {
    // v4: true, // Temporarily disabled to test mobile nav
  },

  // Set the production url of your site here
  url: 'https://learnvertexnova.com',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} VertexNova Engine. Built with Docusaurus.`,
      },
      prism: {
